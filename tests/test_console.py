#!/usr/bin/python3
"""Unit test module for the command interpreter"""
...
class TestHBNBCommand(unittest.TestCase):
    ...
    def test_fs_create(self):
        """Tests the create command with file storage."""
    ...
    def test_db_create(self):
        """Create command test with database storage"""
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_db_count(self):
        """Tests the count command with database storage"""
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            dbc = MySQLdb.connect(
                host=os.getenv('HBNB_MYSQL_HOST'),
    ...
    def test_db_show(self):
        """Show command test with the database storage"""
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
